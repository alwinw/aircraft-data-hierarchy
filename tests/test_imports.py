...
class TestImports(unittest.TestCase):
    ...
    def test_import_work_breakdown_structure_airframe(self):
        try:
            ...
            self.fail(
                "Failed to from aircraft_data_hierarchy.work_breakdown_structure.airframe"
            )
    ...
    def test_import_work_breakdown_structure_propulsion(self):
        try:
            ...
            self.fail(
                "Failed to from aircraft_data_hierarchy.work_breakdown_structure.propulsion"
            )
    ...
    def test_import_work_breakdown_structure_systems(self):
        try:
            ...
            self.fail(
                "Failed to from aircraft_data_hierarchy.work_breakdown_structure.systems"
            )
