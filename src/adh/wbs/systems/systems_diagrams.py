...
def create_system_attribute_tables(system: System) -> list[tuple[str, str]]:
        ...
        (
            ...
            [
                ...
                [
                    ...
                    f"{cooling.max_operating_temperature:.1f}",
                    "°C",
                ],
            ],
        )
    ...
    tables.append(
        (
            ...
            [
                ...
                [
                    "Frequency",
                    f"{power.frequency:.1f}" if power.frequency else "N/A",
                    "Hz",
                ],
    ...
    return [
        (title, tabulate(data, headers="firstrow", tablefmt="html"))
...
def display_system_info(system: System):
    ...
    html_tables = (
        ...
        + "".join(
            [
                f"<td style='vertical-align:top'><h4>{title}</h4>{table}</td>"
